"""Pure two-axis operator-intent classification for the physical JSM."""
...
class ClassifiedIntent:
    """Normalized ROS-frame axes and their operator-facing classification."""
...
def classify_raw_axes(
    ...
    *,
    ...
    return classify_normalized_axes(
        -float(x_raw) / 100.0,
        float(y_raw) / 100.0,
...
def intent_label(intent_class: int) -> str:
    """Return the stable wire/console label for an intent-class constant."""
