"""Rolling performance statistics for the active mapping pipeline."""
...
class MappingMetrics:
    """Track recent successful filter timings and output rate."""
        ...
        values.update(
            {
                ...
                "processing_p50_ms": "%.3f" % float(np.percentile(history, 50)),
                "processing_p95_ms": "%.3f" % float(np.percentile(history, 95)),
