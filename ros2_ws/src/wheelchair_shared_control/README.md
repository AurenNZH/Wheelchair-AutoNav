...
The supervisor combines `/operator_intent`, `/nav2_front_costmap`, and the
...
ros2 bag play /path/to/bag --topics /nav2_front_costmap \
  --remap /nav2_front_costmap:=/replay/nav2_front_costmap
```

The replay restamper republishes the recorded grid on `/nav2_front_costmap` and
